...
//   function countryid (x) {
//     let mycountry = results.find(item => item.id === x);
//     console.log(mycountry.shipAddress.country);
// }
...
// let mycountry = results.filter(item => item.shipAddress.country === x);
...
// function countryid (x){
// let mycountry = results.find(item => item.id ===x);
// console.log(mycountry.shipName);
// console.log(mycountry.shipAddress.country);
// console.log(mycountry.shipAddress.city);
...
// // function countryid (x){
// //     let mycountry = results.find(item => item.id ===a);
// //     console.log(mycountry.details);
// }
